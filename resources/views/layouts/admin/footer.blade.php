    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">{{ $websiteLang->where('lang_key','delete')->first()->custom_lang }}</button>
                </form>
    ...
    //   check home section value
      $("#section_type").on('change',function(){
        ...
        $("#addRow").on('click',function () {
            ...
            html+='<label for="link">{{ $websiteLang->where("lang_key","link")->first()->custom_lang }}</label>'
        ...
        $("#addImageRow").on('click',function () {
            ...
            html+='<div class="col-md-9">';
            html+='<div class="form-group">';
            html+='<label for="">{{ $websiteLang->where("lang_key","img")->first()->custom_lang }}</label>';
        ...
        $("#addMedicineRow").on('click',function () {
            ...
            html+='<div class="col-md-9">';
            html+='<div class="form-group">';
            html+='<label for="">{{ $websiteLang->where("lang_key","name")->first()->custom_lang }}</label>';
